...
import { Home, Users, CreditCard, TrendingUp, Calendar, User, LogOut } from 'lucide-react';
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-2 py-1 z-50">
      <div className="flex justify-around items-center">
        ...
        <button
          onClick={() => logout()}
          className="flex flex-col items-center px-2 py-2 text-xs text-red-500 hover:text-red-600 transition-colors"
        >
